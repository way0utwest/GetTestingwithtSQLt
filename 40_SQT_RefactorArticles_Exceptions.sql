...
Class: 
	Articles
Name: 
	SetArticlesReadingEstimate with No Parameter

 -- same as update test, but no article
*/
CREATE PROCEDURE [Articles].[test SetArticlesReadingEstimate with No Parameter]
AS
BEGIN
...
ALTER PROCEDURE [Articles].[test SetArticlesReadingEstimate with No Parameter]
AS
BEGIN
